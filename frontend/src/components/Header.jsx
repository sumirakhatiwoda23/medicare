...
export default function Header() {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary mx-18 rounded-lg px-6 md:px-10 lg:px-20'>
{/* ---left side */}
...
href="#speciality">Book appointment <img  className='w-3'
