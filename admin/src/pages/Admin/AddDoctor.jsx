            ...
            <div className='bg-white px-8 py-8 border border-white rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <input
                                ...
                                value={address1}
                                className='border border-white rounded px-3 py-2 mb-2'
                                type="text"
                ...
                <div className='mt-4 flex-1 flex flex-col gap-1'>
                    ...
                    <textarea
                        ...
                        value={about}
                        className='w-full px-4 pt-2 border border-white rounded'
                ...
                <button
                    type='submit'
                    className='bg-primary px-10 py-3 mt-4 text-white cursor-pointer rounded-full'
                >
                    Add doctor
                </button>
            </div>
